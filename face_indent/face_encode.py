...
# step 1 :
imgElon = face_recognition.load_image_file(dir_path + "/pic/elon musk.jpg")
imgElon =cv2.cvtColor(imgElon,cv2.COLOR_BGR2RGB)
imgCheck = face_recognition.load_image_file(dir_path + "/pic/elon check.jpg")
imgCheck =cv2.cvtColor(imgCheck,cv2.COLOR_BGR2RGB)

imgCheck2 = face_recognition.load_image_file(dir_path + "/pic/minh.png")
imgCheck2 =cv2.cvtColor(imgCheck2,cv2.COLOR_BGR2RGB)
...
faceCheck2 = face_recognition.face_locations(imgCheck2)[0]
encodeCheck2 = face_recognition.face_encodings(imgCheck2)[0] # mã hóa ảnh
cv2.rectangle(faceCheck2,(faceCheck2[3],faceCheck2[0]),(faceCheck2[1],faceCheck2[2]),(255,0,255),2)
